...
# Save the KNN model if it has the highest test accuracy
import joblib
...
if best_model_name == 'KNN':
    ...
    print("KNN model saved as 'best_knn_model.joblib'")

    # Also dump the scaler used in the KNN pipeline
    scaler = best_model.named_steps['scalar']
    joblib.dump(scaler, 'knn_scaler.joblib')
    print("Scaler used in KNN model saved as 'knn_scaler.joblib'")
